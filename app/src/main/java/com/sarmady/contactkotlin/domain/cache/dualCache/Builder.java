...
public class Builder {
     ...
     * @return the builder.
     */
    public Builder useSerializerInRam(
            int maxRamSizeBytes, CacheSerializer serializer
    ) {
     ...
     * @return the builder.
     */
    public Builder useReferenceInRam(
            int maxRamSizeBytes, SizeOf handlerSizeOf
    ) {
     ...
     * @return the builder.
     */
    public Builder useSerializerInDisk(
     ...
     */
    public Builder useSerializerInDisk(
            int maxDiskSizeBytes, File diskCacheFolder, CacheSerializer serializer
    ) {
